...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    metrics: [
      { label: "Test Suite", value: "316 tests / 33 files", status: "measured" },
      { label: "Corpus", value: "1,117 chunks / 23 repos", status: "measured" },
    ],
    demo: {
      kind: "metrics",
      metrics: [
        { label: "Vitest Suite", value: "316 tests / 33 files", status: "measured" },
